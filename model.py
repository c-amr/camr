...
class Model():
    ...
    def setup(self,action_type,instances,feature_templates_file=None):
        ...
        self.read_templates(feature_templates_file)
    ...
    def read_templates(self, feature_templates_file): 

        ff_name = feature_templates_file if feature_templates_file else _FEATURE_TEMPLATES_FILE
    ...
    def output_feature_generator(self):
        ...
        import time
        self._feats_gen_filename = 'feats_gen_'+str(int(time.time()))
